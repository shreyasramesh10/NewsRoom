...
import com.android.shreyas.newsroom.ScaleToFitWidhtHeigthTransform;
...
public class CircularAdapter extends CircularLoopAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Picasso.with(mContext).load(getItem(position)).transform(new ScaleToFitWidhtHeigthTransform(mRowHeight, true)).
                into(holder.image);
